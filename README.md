...
Unfortunately, due to the Unsplash API providing a lot of data, but only the "alt" text in each object containing any usable text for matching search terms, there were not other tags of keywords to match the query with other than the alt description.
